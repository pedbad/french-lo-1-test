...
Current SCSS footprint (7 files), grouped by area:
- Core/layout: `src/App.scss`
- Activities & exercises: `src/components/Blanks/Blanks.scss`, `src/components/CustomComponents_FR/CustomComponents_FR.scss`
