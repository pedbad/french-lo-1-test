...
export const PhoningInFranceGrammarTelephoneNumbers = memo(function PhoningInFranceGrammarTelephoneNumbers({ id }) {
  return (
    <div id={id || undefined}>
      <h3>1. Telephone numbers in France</h3>
      {/* The #RegionalTelephoneMap id below is required — all map CSS is scoped to it */}
...
export const PhoningInFranceGrammarBienForConfirmation = memo(function PhoningInFranceGrammarBienForConfirmation({ id }) {
