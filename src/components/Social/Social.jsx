...
export class Social extends React.PureComponent {
  render = () => {
    return (
      <div className="hidden w-[1024px] mx-auto" id={`social`}>
        <h2 className="text-left">Follow us</h2>
        <section className="social-icons-section mt-4 mb-2">
          <ul className="flex">
            <li className="m-1">
              <a
                className="text-foreground transition-colors duration-200 ease-in-out hover:text-primary focus-visible:text-primary"
                href="https://www.facebook.com/uclangcen"
                aria-label="Facebook"
              >
                {/* Inline SVG so currentColor can be themed via CSS. */}
                <svg
                  className="social-icon block w-8 h-8 fill-current"
            ...
            <li className="m-1">
              <a
                className="text-foreground transition-colors duration-200 ease-in-out hover:text-primary focus-visible:text-primary"
                href="https://www.linkedin.com/company/94076110"
                aria-label="LinkedIn"
              >
                {/* Inline SVG so currentColor can be themed via CSS. */}
                <svg
