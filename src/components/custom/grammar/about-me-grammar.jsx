...
export const AboutMeGrammarVerbs = memo(function AboutMeGrammarVerbs({ id }) {
...
export const AboutMeGrammarGenderAndArticles = memo(function AboutMeGrammarGenderAndArticles({ id }) {
  return (
...
export const AboutMeGrammarSubjectPronouns = memo(function AboutMeGrammarSubjectPronouns({ id }) {
  return (
