...
export const FreeTimePronunciationTionSound = memo(function FreeTimePronunciationTionSound({ id }) {
  return (
...
export const FreeTimePronunciationMoreTionWords = memo(function FreeTimePronunciationMoreTionWords({ id }) {
  return (
