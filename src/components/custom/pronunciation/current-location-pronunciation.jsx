...
export const CurrentLocationPronunciationNasalInAin = memo(function CurrentLocationPronunciationNasalInAin({ id }) {
  return (
...
export const CurrentLocationPronunciationRelatedSpellings = memo(function CurrentLocationPronunciationRelatedSpellings({ id }) {
  return (
...
export const CurrentLocationPronunciationFinalEnEns = memo(function CurrentLocationPronunciationFinalEnEns({ id }) {
  return (
