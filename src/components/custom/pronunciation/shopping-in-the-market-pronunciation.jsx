...
export const ShoppingInTheMarketPronunciation = memo(function ShoppingInTheMarketPronunciation({ id }) {
  return (
    <div className={`lo12-demystify1-container container`} id={id || undefined}>
      <div className={`panel pronunciation-panel`} id={id ? `${id}Panel1` : undefined}>
        ...
        <div className={`pronunciation-content`}>
          <div className={`pronunciation-text`}>
            ...
            <div>Here are some examples. Listen to each pair. You should hear that they sound different:</div>
            <p>
