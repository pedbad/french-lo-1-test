...
export const OpinionsMatterGrammarBorrowedNouns = memo(function OpinionsMatterGrammarBorrowedNouns({ id }) {
  return (
    <div id={id || undefined}>
...
export const OpinionsMatterGrammarLikesAndInfinitives = memo(function OpinionsMatterGrammarLikesAndInfinitives({ id }) {
  return (
    <div id={id || undefined}>
...
export const OpinionsMatterGrammarInterrogatives = memo(function OpinionsMatterGrammarInterrogatives({ id }) {
  return (
    <div id={id || undefined}>
