...
export const GoingToACafeGrammarConditionalVouloir = memo(function GoingToACafeGrammarConditionalVouloir({ id }) {
  const vouloirRows = [
    {
...
export const GoingToACafeGrammarPrendre = memo(function GoingToACafeGrammarPrendre({ id }) {
  const prendreRows = [
    {
...
export const GoingToACafeGrammarFlavoursWithA = memo(function GoingToACafeGrammarFlavoursWithA({ id }) {
  const flavourRows = [
    {
...
export const GoingToACafeGrammarDisjunctivePronouns = memo(function GoingToACafeGrammarDisjunctivePronouns({ id }) {
  const exampleRows = [
    {
