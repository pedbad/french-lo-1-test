						...
						<div className="space-y-1.5">
							<div className="grid w-full grid-cols-[minmax(0,1fr)_2.5rem] items-center gap-2">
								<Input
									...
									className={`min-h-10 text-[length:var(--font-size-sm)] md:text-base ${inputToneClass}`}
