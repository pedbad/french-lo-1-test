					...
					<div className="flex items-start gap-3">
						...
						<div className="min-w-0 flex-1">
							{promptText ? (
								item?.audio ? (
									<button
										className={`m-0 cursor-pointer border-0 bg-transparent p-0 text-left text-fs-sm leading-[var(--line-height-app)] transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 md:text-base ${
									...
									<p className="m-0 text-fs-sm leading-[var(--line-height-app)] text-foreground md:text-base">
										{promptText}
									</p>
								)
							) : null}
							...
							<div className="mt-2 grid grid-cols-[minmax(0,1fr)_2.75rem] items-start gap-x-3">
								<div className="min-w-0 text-fs-sm leading-[var(--line-height-app)] text-foreground md:text-base">
