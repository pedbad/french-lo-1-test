...
export const AboutMePronunciationSilentE = memo(function AboutMePronunciationSilentE({ id }) {
...
export const AboutMePronunciationFrenchTh = memo(function AboutMePronunciationFrenchTh({ id }) {
  return (
