...
export const OpinionsMatterPronunciationBorrowedWords = memo(function OpinionsMatterPronunciationBorrowedWords({ id }) {
  return (
...
export const OpinionsMatterPronunciationFinalConsonants = memo(function OpinionsMatterPronunciationFinalConsonants({ id }) {
  return (
