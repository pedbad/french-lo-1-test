...
export const PlanningAHolidayGrammarWeather = memo(function PlanningAHolidayGrammarWeather({ id }) {
  const faireRows = [
    {
      english: "It's hot.",
...
export const PlanningAHolidayGrammarAllerNearFuture = memo(function PlanningAHolidayGrammarAllerNearFuture({ id }) {
  const allerRows = [
    {
