...
export const DailyRoutineGrammarOn = memo(function DailyRoutineGrammarOn({ id }) {
  return (
    <div id={id || undefined}>
...
export const DailyRoutineGrammarReflexiveVerbs = memo(function DailyRoutineGrammarReflexiveVerbs({ id }) {
  const reflexiveRows = [
    {
...
export const DailyRoutineGrammarReflexiveBeforeVowel = memo(function DailyRoutineGrammarReflexiveBeforeVowel({ id }) {
  const appelerRows = [
    {
      english: "I am called",
