...
export const ShoppingInTheMarketGrammarAller = memo(function ShoppingInTheMarketGrammarAller({ id }) {
  const allerRows = [
    {
...
export const ShoppingInTheMarketGrammarPartitivesAndQuantities = memo(function ShoppingInTheMarketGrammarPartitivesAndQuantities({ id }) {
  const partitiveRows = [
    {
      english: "some cheese",
      french: <>du fromage</>,
...
export const ShoppingInTheMarketGrammarPluralForms = memo(function ShoppingInTheMarketGrammarPluralForms({ id }) {
  const pluralRows = [
    {
