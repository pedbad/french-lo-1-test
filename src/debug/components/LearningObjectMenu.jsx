function getLearningObjectLabel(learningObject, index) {
...
export function LearningObjectMenu({
  currentLearningObject = 0,
  appHrefBase,
  learningObjects,
  onSelectLearningObject,
}) {
  const selectLearningObject = (index) => {
  ...
  if (learningObjects !== undefined) {
    ...
    learningObjects.forEach((learningObject, index) => {
      const { badge, title } = getLearningObjectLabel(learningObject, index);
      ...
      renderedMenu.push(
        <li
          ...
          <a
            ...
            href={loPath}
            onClick={() => selectLearningObject(index)}
          >
