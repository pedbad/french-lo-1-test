...
export const HouseAndHomeGrammarThirdPersonForms = memo(function HouseAndHomeGrammarThirdPersonForms({ id }) {
  return (
    <div
...
export const HouseAndHomeGrammarAdjectivalAgreement = memo(function HouseAndHomeGrammarAdjectivalAgreement({ id }) {
  return (
    <div
