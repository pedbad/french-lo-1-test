...
export const StudyingAtUniversityGrammarComme = memo(function StudyingAtUniversityGrammarComme({ id }) {
  const commeRows = [
    {
...
export const StudyingAtUniversityGrammarDevoir = memo(function StudyingAtUniversityGrammarDevoir({ id }) {
  const exampleRows = [
    {
...
export const StudyingAtUniversityGrammarPouvoir = memo(function StudyingAtUniversityGrammarPouvoir({ id }) {
  const pouvoirRows = [
    {
...
export const StudyingAtUniversityGrammarParticiples = memo(function StudyingAtUniversityGrammarParticiples({ id }) {
  const presentRows = [
    {
      english: "It's tiring",
