...
const modalTitleClass = "text-base sm:text-lg max-[650px]:!text-lg";
const modalBodyClass = "space-y-3 text-base leading-relaxed text-foreground sm:text-lg [&_h2]:max-[650px]:!text-lg [&_h3]:max-[650px]:!text-lg [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:my-1";
