...
import { INSTRUCTION_TEXT_CLASS, InstructionsMedia } from "./instructions-media";
			...
			>
				<Card className="w-full sortable mt-6">
					<CardHeader className="px-6 pb-4 pt-6">
						...
						{instructionsLayout ? (
							<InstructionsMedia {...instructionsLayout} instructionTextClass={INSTRUCTION_TEXT_CLASS} />
						) : (
							<>
								...
								{instructionsTextHTML ? <div className={`instructions html section mt-0 ${INSTRUCTION_TEXT_CLASS}`} style={{ margin: 0 }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(instructionsTextHTML) }} /> : null}
							</>
						)}
