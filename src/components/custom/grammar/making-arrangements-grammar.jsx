...
export const MakingArrangementsGrammarVouloir = memo(function MakingArrangementsGrammarVouloir({ id }) {
  const vouloirRows = [
    {
      english: "I want",
      french: <>je veux</>,
...
export const MakingArrangementsGrammarPrepositionA = memo(function MakingArrangementsGrammarPrepositionA({ id }) {
