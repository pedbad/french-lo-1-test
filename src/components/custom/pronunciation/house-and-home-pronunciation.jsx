...
export const HouseAndHomePronunciationNasalAn = memo(function HouseAndHomePronunciationNasalAn({ id }) {
  return (
...
export const HouseAndHomePronunciationRelatedSpellings = memo(function HouseAndHomePronunciationRelatedSpellings({ id }) {
  return (
