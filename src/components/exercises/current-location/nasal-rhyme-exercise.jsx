...
export function CurrentLocationNasalRhymeExercise({ id }) {
  const [showNasalHighlights, setShowNasalHighlights] = useState(false);

  const toggleNasalHighlights = () => {
    setShowNasalHighlights((prev) => !prev);
  };
            ...
            <CardContent className="p-4 sm:p-5">
              ...
              >
                <div className="mb-3 flex flex-wrap items-center justify-between gap-2 border-b border-border-subtle/70 pb-2">
                  <h4 className="m-0 flex items-center gap-2 text-lg" id={id ? `${id}-poem-title` : undefined}>
