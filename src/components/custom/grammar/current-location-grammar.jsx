...
export const CurrentLocationGrammarPrepositionsInPlaces = memo(function CurrentLocationGrammarPrepositionsInPlaces({ id }) {
  ...
  return (
    <div id={id || undefined}>
      <p style={{ marginTop: 0 }}>
        ...
        <strong>dans le</strong> depending on context. The chart below shows when each form is used:
      </p>
